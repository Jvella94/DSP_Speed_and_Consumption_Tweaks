...
namespace DSP_Speed_and_Consumption_Tweaks
{
    ...
    public class DSP_Speed_and_Consumption_TweaksPlugin : BaseUnityPlugin
    {
        ...
        // e.g.
        // float myFloat = DSP_Speed_and_Consumption_TweaksPlugin.FloatExample.Value;
        ...
        private void Awake()
        {
            ...
            // .e.g.
            // DSP_Speed_and_Consumption_TweaksPlugin.Log.LogDebug("Debug Message to BepInEx log file");
            Log = Logger;
        }
        ...
        private void Update()
        {
            if (DSP_Speed_and_Consumption_TweaksPlugin.KeyboardShortcutExample.Value.IsDown())
            {
